<?php
$pluem = new classweb;
$show_product_limit = $pluem->show_product_limit();
?>
<div class="container mt-2">
    <?php if(empty($show_product_limit)){ ?>
        <div class="text-center"><h1 class="text-fff">ไม่มีสินค้า ณ ขณะนี้</h1></div>
    <?php }else{ ?>
    <div class="row">
        <div class="col-12">
        <h1 class="text-fff">สินค้าแนะนำ</h1>
            <div class="card-deck">
                <div class="row">
                    <?php foreach ($show_product_limit as $row){ ?>
